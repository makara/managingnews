Drupal.behaviors.mn_core_behavior_scalepoints = function(context) {
  var data = $(context).data('openlayers');
  if (data && data.map.behaviors.mn_core_behavior_scalepoints) {
    var styles = data.map.behaviors.mn_core_behavior_scalepoints.styles;
